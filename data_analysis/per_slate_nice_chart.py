...
prediction_slates = ["10", "11", "12", "13", "14", "17", "19", "23", "25", "21"]
...
def get_model_params(phase, letter, df_row):
    ...
    base_network = exp_name.split("exp", 1)[1]
    ...
    for letter in all_letters:
        try:
            ...
            if not sub_df.empty:
                ...
                chart_dict["Mean Metric"].append(sub_df["mean_metric"].item())
                chart_dict["Best Metric"].append(sub_df["weighted_metric"].item())
