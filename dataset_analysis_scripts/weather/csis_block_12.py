# Package ID: knb-lter-jrn.210548057.30 Cataloging System:https://pasta.edirepository.org.
# Data set title: Jornada Basin LTER Cross-scale Interactions Study (CSIS) Block 12 meteorological station: Daily summary data: 2013 - ongoing.
...
infile1  ="https://pasta.lternet.edu/package/data/eml/knb-lter-jrn/210548057/30/cb82735843c46be1ade34abadb702177".strip() 
...
print(dt1.WS_ms_37cm_Avg.describe())               
print("--------------------\n\n")
                    
print(dt1.Flag_WS_ms_37cm_Avg.describe())               
print("--------------------\n\n")
...
print(dt1.WS_ms_37cm_Max.describe())               
print("--------------------\n\n")
                    
print(dt1.Flag_WS_ms_37cm_Max.describe())               
print("--------------------\n\n")
