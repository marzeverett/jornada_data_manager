...
def create_dataset_name(ds, l, ds_combo, l_combo, idays, odays):
    version = 1
    name = "simple_reg_weather.v"+str(version)+".ds"+str(ds)+".l"+str(l)+".ds_combo"+str(ds_combo)+".l_combo"+str(l_combo)+".idays"+str(idays)+".odays"+str(odays)
    return name
...
print(global_data_descriptors_list[8969])
...
#dataset_descriptor, dataset_result, experiment_descriptor, experiment_result = model_generator.experiment_from_experiment_object(descriptors_list[0], experiment_1)
